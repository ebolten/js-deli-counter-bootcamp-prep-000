...
<p data-visibility='hidden'>View <a href='https://learn.co/less-ons/js-deli-counter' title='Deli Counter Lab'>Deli Counter Lab</a> on Learn.co and start learning to code for free.</p>
